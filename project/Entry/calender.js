    ...
    for(let h = 0; h < months[i].days.length; h++){
        ...
        for(let r = 0; r < months[i].days[h].sessions.length; r++){
            currentDay.innerHTML += `<div class="session">
                ...
                <p class="sessionInfo2">${months[i].days[h].sessions[r].dataPoints[0].value}${months[i].days[h].sessions[r].dataPoints[0].name}</p>
                <p class="sessionInfo3">${months[i].days[h].sessions[r].dataPoints[0].value}${months[i].days[h].sessions[r].dataPoints[0].name}</p>
            </div>`;
        }
    }
}